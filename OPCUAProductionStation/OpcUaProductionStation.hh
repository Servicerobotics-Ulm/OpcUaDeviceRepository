...
class ProductionStation : public OPCUA::GenericServer
{
private:
	ProductionStationInterface *controller;
	
	/** this method implements the server space for ProductionStation
	 *
...
public:
	ProductionStation(ProductionStationInterface *controller);
