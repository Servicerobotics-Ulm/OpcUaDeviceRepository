...
#ifndef _TRAFFICLIGHT_HH
#define _TRAFFICLIGHT_HH
...
class Trafficlight : public OPCUA::GenericServer
{
private:
	TrafficlightInterface *controller;
	
	/** this method implements the server space for Trafficlight
	 *
...
public:
	Trafficlight(TrafficlightInterface *controller);
	virtual ~Trafficlight();
};

} /* namespace OPCUA */

#endif /* _TRAFFICLIGHT_HH */
